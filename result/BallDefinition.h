...
public:
	...
	Ball(Float Radius, Float Distance, Float Speed, Float SelfSpeed, Ball * Parent, Float3 color);
...
public:
    ...
    MatBall(Float Radius, Float Distance, Float Speed, Float SelfSpeed, Ball * Parent, Float3 color);
